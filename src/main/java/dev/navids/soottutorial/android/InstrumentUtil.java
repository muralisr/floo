...
public class InstrumentUtil {
    public static final String TAG = "<MURALI>";
    ...
    public static boolean isAndroidMethod(SootMethod sootMethod){
        ...
        List<String> listOfProhibitedStrings = new ArrayList<>();
        listOfProhibitedStrings.add("$$Lambda");
        listOfProhibitedStrings.add("dagger");
        listOfProhibitedStrings.add("com.urbanairship");
        listOfProhibitedStrings.add("kotlin");
        listOfProhibitedStrings.add("Cipher");
        listOfProhibitedStrings.add("cipher");
        listOfProhibitedStrings.add("okhttp3");
        for(String s : listOfProhibitedStrings)
            if (clsSig.contains(s)) return true;
        List<String> androidPrefixPkgNames = Arrays.asList("com.android","android.", "com.google", "androidx.", "kotlin.", "io.", "com.fasterxml", "com.amazon", "com.adobe", "com.facebook", "junit.", "ognl.", "org.hamcrest.", "org.junit.", "org.unitils");
